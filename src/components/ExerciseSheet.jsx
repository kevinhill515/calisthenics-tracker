...
export default function ExerciseSheet({ exerciseId, open, onClose }) {
  ...
  // Show recent history of this exercise
      ...
      <div className="px-5 py-4 space-y-5">
        ...
        {ex.yt && (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="block w-full text-center bg-rose-500/10 border border-rose-500/30 text-rose-400 hover:bg-rose-500/20 rounded-xl py-3 font-medium"
          >
