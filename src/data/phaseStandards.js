...
export const PHASE_STANDARDS = {
  1: [
    ...
    { id: 'p1-hang',    label: 'Active hang',                       exerciseId: 'active-hang',       target: 30, unit: 'sec' },
  ],
  2: [
    ...
    { id: 'p2-wallhs',  label: 'Wall handstand (chest-to-wall)',    exerciseId: 'wall-handstand-ctw',target: 60, unit: 'sec' },
  ...
  3: [
    ...
    { id: 'p3-advtfl',  label: 'Advanced tuck front lever',         exerciseId: 'adv-tuck-fl',       target: 10, unit: 'sec' },
    ...
    { id: 'p3-oapneg',  label: 'One-arm chin-up negative',          exerciseId: 'oa-chin-negative',  target: 5,  unit: 'sec' },
    { id: 'p3-strhspu', label: 'Wall straddle handstand push-up',   exerciseId: 'wall-straddle-hspu',target: 5,  unit: 'rep' },
  ...
  4: [
    ...
    { id: 'p4-fhspu',   label: 'Freestanding handstand push-up',    exerciseId: 'freestanding-hspu', target: 1,  unit: 'rep' },
    ...
    { id: 'p4-bl',      label: 'Full back lever',                   exerciseId: 'full-bl',           target: 10, unit: 'sec' },
  ],
  5: [
    ...
    { id: 'p5-oap',     label: 'Multiple one-arm pull-ups (each side)', exerciseId: 'oap',           target: 2,  unit: 'rep' },
    { id: 'p5-fhspu',   label: 'Multiple freestanding handstand push-ups', exerciseId: 'freestanding-hspu', target: 3, unit: 'rep' },
